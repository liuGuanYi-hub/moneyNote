...
```text
moneyNote/
├── src/                   # 后端源码（Spring Boot，根级 Maven 工程）
│   ├── main/java/         # Java 业务代码
│   └── main/resources/    # 配置与数据库脚本（db/）
├── frontend/              # 前端站点（React + Vite）
│   └── src/               # pages / components / hooks / stores / services 等
├── docs/                  # 路线图、架构与阶段文档，含 architecture 架构图
├── public/sounds/         # 静态音效资源
├── pom.xml                # Maven 配置
├── README.md              # 项目说明
└── README_BACKEND.md      # 后端专项说明
```
